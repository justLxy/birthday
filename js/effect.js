...
$(document).ready(function(){
    ...
    var balloonsMoving = true; // Add this line

    function loopOne() {
        if (!balloonsMoving) return; // Add this line
    ...
    $('#wish_message').click(function(){
       vw = $(window).width()/2;
       balloonsMoving = false; // Add this line
       $('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8').stop(true, true); // Modify this line
       $('#b1').attr('id','b11');
       $('#b2').attr('id','b22')
       $('#b3').attr('id','b33')
       $('#b4').attr('id','b44')
